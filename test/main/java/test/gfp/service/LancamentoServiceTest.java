...
public class LancamentoServiceTest {
	...
	public void testAgendarLancamentos() throws Exception {
		...
		dto.setDia(10);
		dto.setDataInicio(DateUtils.date(7, 3, 2011));
		dto.setDataFinal(DateUtils.date(31, 12, 2011));
		
		final Date[] vencimentos = { DateUtils.date(10, 3, 2011),
				DateUtils.date(10, 4, 2011), DateUtils.date(10, 5, 2011),
				DateUtils.date(10, 6, 2011), DateUtils.date(10, 7, 2011),
				DateUtils.date(10, 8, 2011), DateUtils.date(10, 9, 2011),
				DateUtils.date(10, 10, 2011), DateUtils.date(10, 11, 2011),
				DateUtils.date(10, 12, 2011) };
		
		dto.setAnteciparFinaisSemana(true);
		final Date[] previsoesAntecipadas = { DateUtils.date(10, 3, 2011),
				DateUtils.date(8, 4, 2011), DateUtils.date(10, 5, 2011),
				DateUtils.date(10, 6, 2011), DateUtils.date(8, 7, 2011),
				DateUtils.date(10, 8, 2011), DateUtils.date(9, 9, 2011),
				DateUtils.date(10, 10, 2011), DateUtils.date(10, 11, 2011),
				DateUtils.date(9, 12, 2011) };
		...
		final Date[] previsoesAtrasadas = { DateUtils.date(10, 3, 2011),
				DateUtils.date(11, 4, 2011), DateUtils.date(10, 5, 2011),
				DateUtils.date(10, 6, 2011), DateUtils.date(11, 7, 2011),
				DateUtils.date(10, 8, 2011), DateUtils.date(12, 9, 2011),
				DateUtils.date(10, 10, 2011), DateUtils.date(10, 11, 2011),
				DateUtils.date(12, 12, 2011) };
		testarAgendamentos(this.controller.agendarLancamentos(dto), lancamento,
				vencimentos, previsoesAtrasadas);
		
		dto.setFrequencia(FrequenciaAgendamentoType.DIA_UTIL_MES.ordinal());
		dto.setDia(5);
		final Date[] vencimentosDiasUteis = { DateUtils.date(7, 4, 2011),
				DateUtils.date(6, 5, 2011), DateUtils.date(7, 6, 2011),
				DateUtils.date(7, 7, 2011), DateUtils.date(5, 8, 2011),
				DateUtils.date(7, 9, 2011), DateUtils.date(7, 10, 2011),
				DateUtils.date(7, 11, 2011), DateUtils.date(7, 12, 2011) };
		testarAgendamentos(this.controller.agendarLancamentos(dto), lancamento,
	...
	public void testListarLancamentos() throws Exception {
		...
		final Lancamento l2 = new Lancamento(u, cd, 10.0,
				FormaPagamentoType.CARTAO);
		l2.setDataVencimento(DateUtils.addDay(1));
		l2.setConta(c);
		l2.save();
		
		final Lancamento l3 = new Lancamento(u, cd, 50.0,
				FormaPagamentoType.DINHEIRO);
		l3.setDataVencimento(DateUtils.addDay(2));
		l3.save();
		...
		dto.setDataFinal(DateUtils.addDay(2));
	...
	public void testListarPrevisaoSaldoDiario() throws Exception {
		...
		assertEquals(DateUtils.today(), dto.dataCompensacao);
		...
		dto = result.get(30);
		assertEquals(DateUtils.addDay(30), dto.dataCompensacao);
		...
		l.setDataPagamento(DateUtils.date(26, 10, 2010));
		...
		result = this.controller.listarPrevisaoSaldoDiario(u.getId(),
				DateUtils.date(26, 10, 2010));
		
		dto = result.get(0);
		assertEquals(DateUtils.date(26, 10, 2010), dto.dataCompensacao);
		assertEquals(0.0, dto.saldoInicial);
		...
		dto = result.get(3);
		assertEquals(DateUtils.date(29, 10, 2010), dto.dataCompensacao);
		...
		l.setDataVencimento(DateUtils.addDay(1));
	...
	public void testTransferencia() throws Exception {
		...
		final Date d = DateUtils.addDay(1);
