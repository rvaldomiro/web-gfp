package common.components.com.hulstkamp.flex.spark.components
{
	import common.components.com.hulstkamp.flex.spark.skins.NiceToolTipSkin;
	...
	public class NiceToolTip extends SkinnableComponent implements IToolTip
	{
		...
		private static function classConstruct():Boolean
		{
			if (!FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("com.hulstkamp.flex.spark.components.NiceToolTip"))
			{
				...
				FlexGlobals.topLevelApplication.styleManager.setStyleDeclaration("com.hulstkamp.flex.spark.components.NiceToolTip"
																				 , niceToolTipStyles
																				 , true);
			}
			return true;
